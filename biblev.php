...
<div id="mySidenav" class="sidenav2">
	 <a  id="about" href="index.php">Home</a>
	  <a id="blog" ><span style="font-size:20px;cursor:pointer" onclick="openNav()">Commentaries</span></a>
	 <a  id="projects" >
...
//	echo '</td></tr>';
 ...
 if(!empty($_POST['id']) && $_POST['id']==3){
	...
	if(!empty(htmlspecialchars($_POST['search_field'])) && isset($_POST['search']) && !empty($_POST['option']) && $_POST['option']==1){
	...
	if(!empty(htmlspecialchars($_POST['search_field']))  && isset($_POST['search']) && !empty($_POST['option']) && $_POST['option']==2 ){
