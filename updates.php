...
if(isset($_POST['news_submit'])){
    if(strcmp($_POST['user_email'], $session->username)==0){
    ...
    }else echo '<center><H4 style="color:black">UNABLE TO CREATE POST, SENDER EMAIL DOES NOT MATCH WITH SESSION EMAIL</H4></center>';
    /* 
...
<center><h3>Charity & Scholarships </h3>
<button class="accordion" style="opacity: 0.9;width: 53vw">Pending Charity Write-ups</button>
<div class="panel" style="opacity: 0.9;width: 50vw">
  <p>
  <table style="width: 80%;">
    <?php
    ...
    //echo "<tr><td></td><td colspan=4><span id='commenter' >ADD IMAGE</span></td></tr>";
    }else echo "<tr><td>NO PENDING WORD OF GOD FOR APROVAL</td></tr>";
    ?>
...
<button class="accordion" style="opacity: 0.9;width: 53vw">SUBMITTED WORD OF GOD</button>
<div class="panel" style="opacity: 0.9;width: 50vw">
  <p>
 <table style="width: 80%;">
  <?php
  ...
  }else echo "<tr><td>NO WORD OF GOD YET</td></tr>";
  ?>
 </table>
  </p>
</div>
 ...
 <table style="width: 80%; opacity: 0.9;">
  ...
  if(!empty($posts)){
    foreach($posts as $post){
     ...
     echo "<input type='hidden' name='newz' value='".$post->id."'>";
     echo "<td>".$nos."<td>";
     echo "<td><b style='color:black'>".strtoupper($post->topic)."</b></td>";
     
     echo "<td><button type='submit' name='deleter3' style='width: auto'>DELETE</button></td>";
    // $files="";
    // if($post->filename!="null") $files = $post->filename;
    // echo '<td><img src="images/news/'.$files.'" style="height: auto; width: 50px; object-fit: contain" /></td>';
     echo "</tr></form>";
...
<button class="accordion" style="opacity: 0.9;width: 53vw"><span style="width:100%">WRITTEN DEVOTIONALS</span></button>
<div class="panel" style="opacity: 0.9;width: 50vw">
  <p>
 <table style="width: 100%; opacity: 0.9;">
  <?php
