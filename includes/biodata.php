...
class Biodata  {
	...
	protected static $table_name="biodata";
	protected static $db_fields = array('id', 'user_id', 'surname', 'first_name', 'DOB_day', 'DOB_month', 'DOB_year', 'phone_no', 'email', 'sex', 'sign_up_date', 'filename', 'favorite_vs');
...
public static function change_message($id, $new){
   ...
   public static function change_filename($id, $new_password){
      	self::find_by_sqlv( " UPDATE ".self::$table_name." SET filename = '".$new_password."' where id = ".$id);
   }
