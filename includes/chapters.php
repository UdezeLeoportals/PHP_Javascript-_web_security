...
class Chapters  {
	...
	protected static $table_name="chapters";
	protected static $db_fields = array('id', 'testament_id', 'book_id', 'chapter', 'verses', 'audiofile');
  ...
  public static function find_chapter($book=0,$chap=0) {
		return self::find_by_sql2("SELECT * FROM ".self::$table_name." WHERE book_id=? AND chapter=? order by verses ASC", $book, $chap);
  }
  public static function find_by_book($bk_id) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE book_id=? order by chapter ASC", $bk_id);
  } 
  ...
  public static function find_approval($course="", $session="", $semester="") {
    ...
    public static function find_active($per_page=10) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE semester_id = {$per_page} ");
    }
 ...
 public static function find_by_sql2($sql="", $bid, $bup) {
