...
class  Elective_no {
	...
	protected static $table_name="elective_no";
	protected static $db_fields = array('id', 'type', 'number', 'unit', 'level');
  ...
  public static function find_active() {
	...
	public static function find_by_type($type=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE type = {$type}  ");
    }
	public static function find_by_cos_id($id=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE course_id = {$code}");
    }
