...
class News_images  {
	...
	protected static $table_name="news_images";
	protected static $db_fields = array('id', 'news_id', 'filename',  'date_time', 'category');
	...
	public $date_time;
        ...
        public function attach_file($file){
            ...
            elseif($file['error'] != 0)
            {
                ...
                $this->filename=gettime().basename($file['name']);
                $this->type=$file['type'];
                $this->size=$file['size'];
                return true;
            }
