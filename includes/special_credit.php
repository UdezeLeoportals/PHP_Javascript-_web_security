...
class Special_credit {

	protected static $table_name="special_credit";
	protected static $db_fields = array('id', 'student_id','semester_id', 'max_credit' );
   ...
   public static function find_all() {
     ...
     public static function find_by_std($student_id=0, $sem_id=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE student_id={$student_id} AND semester_id={$sem_id} LIMIT 1");
  }
public static function find_by_sem($std_id=0, $sem_id=0) {
  ...
  public static function find_per_session($matric="", $session="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE matric_no=\"{$matric}\" AND session=\"{$session}\" ");
  }
