...
class Untakes  {
	...
	protected static $table_name="untakes";
   ...
   public static function find($std_id, $course){
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE ( student_id = {$std_id} AND course_id = {$course}) ");
   }
