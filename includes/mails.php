...
class Mails  {
	...
	protected static $db_fields = array('id', 'sender', 'receiver', 'email', 'date_time', 'read', 'subject');
   ...
   public static function change_password($id, $new_password){
	...
	public static function change_role($id, $a=0, $e=0){
      	self::find_by_sql( " UPDATE ".self::$table_name." SET assessment = ".$a.", exam_score = ".$e." where id = ".$id);
    }
