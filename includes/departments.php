...
class Departments  {
	...
	protected static $db_fields = array('id', 'unit', 'dept', 'faculty', 'duration');
   ...
   public static function find_all() {
    ...
    public static function find_unit($unit="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE unit='{$unit}' LIMIT 1");
    }
     public static function find_by_dept($unit="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE dept='{$unit}' ");
    }
