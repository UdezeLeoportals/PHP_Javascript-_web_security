...
class Registered_course  {
	...
	protected static $table_name="registered_courses";
	protected static $db_fields = array('id','student_id','semester_id','course_id', 'result_pt');
   ...
   public static function find_all() {
	...
	public static function find_code($student_id=0, $course_id=0, $semester_id=0) {
