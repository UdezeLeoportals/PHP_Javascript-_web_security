...
class Signature  {
	...
	protected static $db_fields = array('id', 'student_id','filename', 'type','size');
	...
	public $student_id;
        private $temp_path;
        protected $upload_dir="Signatures";
        public $errors= array();
		...
		if(isset($this->id)) {
			...
			$this->update();
                    ...
                    $target_path = SITE_ROOT.DS."images".DS.$this->upload_dir.DS.$this->filename;
