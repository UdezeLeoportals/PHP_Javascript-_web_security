...
class Photos  {
	...
	protected static $db_fields = array('id', 'biodata_id', 'filename',  'date_time', 'paper_title', 'fieldOS', 'journal', 'year', 'file_type');
   ...
   public $temp_path;
	public $date_time;
		public $paper_title;
			public $fieldOS; //WEEK ON CHURCH CALENDAR
				public $journal;
					public $year;
					public $file_type;
        protected $upload_dir="images/profiles";
        public $errors= array();
   ...
   public static function find_authors() {
		return self::find_by_sql("SELECT DISTINCT biodata_id FROM ".self::$table_name." WHERE file_type= 'paper' order by year");
  }
   public static function find_public($bioid) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE ( file_type= 'paper' AND biodata_id={$bioid} ) order by year");
  }
  ...
  public static function find_by_type() {
     return  self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE file_type='JESUS_CHRIST_Divina' ");
