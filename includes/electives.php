...
class  Electives {
	...
	protected static $table_name="electives";
	protected static $db_fields = array('id', 'course_id', 'type', 'pair');
  ...
  public static function find_active() {
	...
	public static function find_by_cos_id($id=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE course_id = {$id}");
    }
