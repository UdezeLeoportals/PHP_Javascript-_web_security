...
class Take_courses  {
	...
	protected static $table_name="take_courses";
	protected static $db_fields = array('id', 'student_id', 'course_id', 'semester_id');
   ...
   public static function find_student($sem1=0, $sem2=0, $std_id=0){
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE ( student_id = {$std_id} AND (semester_id = {$sem1} OR semester_id = {$sem2})) ");
   }
...
public static function find_by_sem($sem1=0, $std_id=0, $cos_id=0){
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE student_id = {$std_id} AND semester_id = {$sem1} AND course_id={$cos_id} ");
   }
   public static function find_sem($sem1=0, $std_id=0){
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE student_id = {$std_id} AND semester_id = {$sem1} ");
   }
