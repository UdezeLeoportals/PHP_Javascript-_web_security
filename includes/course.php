...
class Course  {
	...
	protected static $db_fields = array('id','old_course_code','new_course_code', 'course_title','credit_unit', 'description', 'type', 'semester');
	
	public $id;
	public $old_course_code;
	public $new_course_code;
	public $course_title;
	public $credit_unit;
	public $description;
	public $type;
   ...
   public static function find_all() {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." order by new_course_code ");
  }
  public static function delete($id){
   ...
   public static function gss_find_all() {
	...
	public static function find_by_code($code="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE old_course_code = '{$code}' OR new_course_code= '{$code}' ");
    }
