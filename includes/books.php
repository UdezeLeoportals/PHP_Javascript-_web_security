...
class Books  {
	...
	protected static $db_fields = array('id', 'testament_id', 'book', 'abbrv', 'chapters');
   ...
   public static function find_all() {
		return self::find_by_sql2("SELECT * FROM ".self::$table_name." order by testament_id, id ASC");
  }
  public static function find_by_test($test=0) {
		return self::find_by_sql2("SELECT * FROM ".self::$table_name." WHERE testament_id={$test} order by id");
  }
  public static function find_by_abbrv($abbrev='') {
		return self::find_by_sql2("SELECT * FROM ".self::$table_name." WHERE abbrv='{$abbrev}' LIMIT 1");
  } 
