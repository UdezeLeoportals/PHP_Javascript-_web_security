...
class Faculty  {
	...
	protected static $db_fields = array('id', 'faculty');
   ...
   public static function find_all() {
    ...
    public static function find_faculty($unit="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE faculty='{$unit}' LIMIT 1");
    }
