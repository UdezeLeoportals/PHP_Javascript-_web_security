...
class Clients  {
	...
	protected static $db_fields = array('id', 'user_id', 'type', 'blog');
 ...
 public static function find_by_user_id($test=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE user_id={$test} LIMIT 1");
  }
  public static function find_by_abbrv($abbrev='') {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE abbrv='{$abbrev}' LIMIT 1");
  } 
