...
class Academic_session  {

	protected static $table_name="a_session";
	...
	public $name;
     ...
     public static function find_session($session) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE name='{$session}' ");
  }
