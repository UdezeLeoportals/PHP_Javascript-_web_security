...
class Verifymail  {
	...
	protected static $table_name="verifymail";
	protected static $db_fields = array('id', 'user_id', 'valid', 'twofa');
  ...
  //new function for password retrieval
   public static function find_by_mail($id=""){
      return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE username='".$id."' LIMIT 1");  
  }
  public static function change_a_level($id=0, $a_level){
	...
	//n
   public static function change_valid($user_id, $new_password){
      	self::find_by_sql( " UPDATE ".self::$table_name." SET valid = ".$new_password." where user_id = ".$user_id);
   }
 ...
 // }
  ...
  public static function delete($id=0) {
   ...
   public static function find_by_user_id($id=""){
      return self::find_by_sql2("SELECT * FROM ".self::$table_name." WHERE user_id=? LIMIT 1", $id);  
  }
  ...
  public static function find_by_sql2($sql="", $id) {
	...
	public function create() {
	  ...
	  $sql .= ") VALUES (";
		...
		$sql .= ")";
	  if($database->query4($sql, array_values($attributes), 5)) {
	...
	public function update() {
	  ...
	  ;
	  return ($database->query7($sql, 1, 1, 2)) ? true : false;
	}
