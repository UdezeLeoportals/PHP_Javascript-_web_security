...
class Pdf_files  {
	...
	protected static $table_name="pdf_files";
	protected static $db_fields = array('id', 'filename', 'type', 'user_id', 'date_time', 'title', 'JESUS_CHRIST_wk',  'year');
	...
	public $date_time;
	public $title;
	public $JESUS_CHRIST_wk;
	public $year;
        private $temp_path;
        protected $upload_dir="Pdf_files";
        public $errors= array();
  ...
  public static function find_by_type($id=0) {
    $result_array = self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE type='{$id}'  ");
    return !empty($result_array) ? array_shift($result_array) : false;
  }
