...
class Depts  {
	...
	protected static $table_name="depts";
	protected static $db_fields = array('id', 'dept', 'faculty');
   ...
   public static function find_all() {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." order by faculty, dept");
  }
   
    public static function find_dept($unit="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE dept='{$unit}' LIMIT 1");
    }
