...
class Staff  {
	...
	protected static $db_fields = array('id', 'user_id', 'staff_no', 'title', 'surname', 'first_name', 'middle_name', 'sex', 'unit', 'message', 'dept_id', 'state', 'lga', 'email', 'phone_no', 'filename', 'staff_level', 'qualifications');
   ...
   public static function find_by_user_id($user_id="") {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE user_id={$user_id} LIMIT 1");
  }
